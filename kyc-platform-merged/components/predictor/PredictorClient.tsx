                      ...
                      {forecast.insufficient ? (
                        ...
                        <div>
                          <div style={{ marginBottom: 20, display: 'flex', gap: 16, flexWrap: 'wrap' }}>
                            ...
                            {forecast.meta?.mape != null && <div><span style={{ color: 'var(--dim)', fontSize: 12 }}>Forecast error (MAPE)</span><div style={{ fontWeight: 700, fontSize: 22, fontFamily: 'Lora,serif' }}>{forecast.meta.mape.toFixed(1)}%</div></div>}
                          </div>
                          <table className="table">
                          ...
                          <p style={{ fontSize: 12, color: 'var(--dim)', marginTop: 14, lineHeight: 1.6 }}>
                            ...
                            Confidence bands are ±{forecast.meta?.mape != null ? (forecast.meta.mape * 1.5).toFixed(1) : '10'}%.
